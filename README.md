# Мобильное приложение для обучения футбольным финтам на Cordova / Mobile application for teaching football tricks using Cordova
...
Основными причинами неприбыльности приложения являются неплатёжеспособность целевой аудитории, отсутствие поддрежки и пополнения коллекции финтов.
